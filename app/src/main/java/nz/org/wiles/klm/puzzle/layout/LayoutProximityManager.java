...
public class LayoutProximityManager {
  private final Logger log = LoggerFactory.getLogger(LayoutProximityManager.class);
  ...
  public Grid[][] createLayout(int[] rowFuelTruckCount, int[] colFuelTruckCount, Map<Point, Plane> pointByPlanes) {
    ...
    calculateAvailableFuelingPositions(layout, rowFuelTruckCount, colFuelTruckCount, pointByPlanes);
